...
1. Generate an [access token](https://help.github.com/en/articles/creating-a-personal-access-token-for-the-command-line) and paste it into a plain text file. Update 
[`config.yml`](config/config.yml) with the path to your token file:
